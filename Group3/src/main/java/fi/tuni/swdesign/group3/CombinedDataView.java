...
public class CombinedDataView {
    ...
    CombinedDataView(MainView mainView) {
        ...
        combinedDataTab.setContent(gridPane);
        
        dataButton.setOnAction(new EventHandler<>() {
            @Override
            public void handle(ActionEvent t) {
                DataMenuView dataMenuView = new DataMenuView(CombinedDataView.this.
                        mainView);
                dataMenuView.show();
            }
        });
        ...
        prefButton.setOnAction(new EventHandler<>() {
            ...
            public void handle(ActionEvent t) {
                PreferencesMenuView prefMenuView = new PreferencesMenuView(
                        CombinedDataView.this.mainView);
                prefMenuView.show();
            }
        });
    ...
    private void populateCheckBoxTree(TreeView checkBoxTree) {
        ...
        root.getChildren().addAll(maintenanceItem, conditionItem, 
                temperatureItem, windItem, cloudinessItem);
