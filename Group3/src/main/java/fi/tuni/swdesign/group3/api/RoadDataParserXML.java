...
public class RoadDataParserXML implements RoadDataParser{
     ...
     * @throws IOException 
     */
    public static RoadWeatherData getDOMParsedDocument(org.w3c.dom.Document w3cDocument, String location, String minX, String maxX, String minY, String maxY, String lat, String lon, String startTime) throws MalformedURLException, ProtocolException, IOException {
        ...
        for(int i = 0; i < weatherForecastMembers.getLength(); i++){
            ...
            if(!newRoadWeatherData.getTime().equals(startTime)){
     ...
     * @return 
     */
    public static RoadWeatherData setRoadWeatherData(RoadWeatherData roadWeatherData, String param, String value){
     ...
     * @throws IOException 
     */
    public static TreeMap<String, Float[]> getMonthlyTemperatureData(String location, String minX, String maxX, String minY, String maxY, String date) throws ProtocolException, IOException{
